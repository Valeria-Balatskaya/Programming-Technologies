...
namespace Library.App
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("\nAvailable Actions:");
                Console.WriteLine("1. List all media items");
                Console.WriteLine("2. View registered patrons");
                Console.WriteLine("3. Show available items");
                Console.WriteLine("4. Display borrowed items");
                Console.WriteLine("5. Overdue accounts");
                Console.WriteLine("6. Check out item");
                Console.WriteLine("7. Return item");
                Console.WriteLine("8. View activity log");
